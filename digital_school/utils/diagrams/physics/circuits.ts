...
export function createLRCCircuit(id: string, configuration: 'series' | 'parallel' = 'series'): FBDDiagram {
    ...
    if (configuration === 'series') {
        ...
        // Battery
        elements.push(`
      <line x1="120" y1="180" x2="120" y2="220" stroke="#333" stroke-width="4"/>
      <line x1="130" y1="170" x2="130" y2="230" stroke="#333" stroke-width="2"/>
      <text x="125" y="165" font-size="12" text-anchor="middle">V</text>
    `);
...
export function createMultiResistorCircuit(id: string, resistors: number = 4): FBDDiagram {
    ...
    // Battery
    elements.push(`
    <line x1="120" y1="230" x2="120" y2="270" stroke="#333" stroke-width="4"/>
    <line x1="130" y1="220" x2="130" y2="280" stroke="#333" stroke-width="2"/>
    <text x="125" y="215" font-size="12" text-anchor="middle">V</text>
  `);
