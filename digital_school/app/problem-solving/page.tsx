        ...
        <MathJaxContext config={MATHJAX_CONFIG} version={3}>
            <div className="min-h-screen bg-slate-50 font-sans text-slate-900 pb-20">
                ...
                <div className="bg-white border-b border-slate-200 sticky top-0 z-50">
                    <div className="max-w-7xl 2xl:max-w-[95vw] mx-auto px-6 h-16 flex items-center justify-between">
                ...
                <div className="relative bg-white border-b border-indigo-100/50 pb-8 pt-6 overflow-hidden">
                    ...
                    <div className="max-w-7xl 2xl:max-w-[95vw] mx-auto px-6 relative z-10">
                ...
                <div className="max-w-7xl 2xl:max-w-[95vw] mx-auto px-6 py-8 -mt-8 relative z-20">
                    {/* Main Interface Grid */}
                                  ...
                                  `}>
                                                    ...
                                                    <div className="flex-1 space-y-3">
                                                        ...
                                                        <h4 className="text-slate-800 font-medium leading-relaxed pr-6 line-clamp-3">
                                                            <MathJax inline dynamic>{cleanupMath(q.questionText)}</MathJax>
                                                        </h4>
                                                    </div>
