...
// Sub-components
import { ZoomableImage, mathJaxConfig } from "./question-types/shared";
...
const QuestionImageGallery = memo(({ qId, subIdx, answers, setAnswers, disabled, submitted, setIsUploading, onCaptureClick }: any) => {
