...
import { Eye, EyeOff, Loader2, PartyPopper, AlertCircle, Home, Mail, Phone, Building } from 'lucide-react';
                                    ...
                                    >
                                        <div className="space-y-4 rounded-md border bg-muted/50 p-4 mt-4">
                                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                                <FormField control={form.control} name="class" render={({ field }: { field: ControllerRenderProps<TSignupSchema, 'class'> }) => (
                                                    <FormItem><FormLabel>Class *</FormLabel><FormControl><Input placeholder="e.g., 10" {...field} disabled={isPending} /></FormControl><FormMessage /></FormItem>
                                                )}/>
                                                <FormField control={form.control} name="section" render={({ field }: { field: ControllerRenderProps<TSignupSchema, 'section'> }) => (
                                                    <FormItem><FormLabel>Section *</FormLabel><FormControl><Input placeholder="e.g., B" {...field} disabled={isPending} /></FormControl><FormMessage /></FormItem>
                                                )}/>
                                            </div>
                                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
