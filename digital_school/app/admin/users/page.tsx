...
export default function AdminUsersPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoading(true);
      try {
        // 1. Fetch Current User to determine Dashboard link
  ...
  const dashboardLink = currentUser?.role === 'SUPER_USER' ? '/super-user/dashboard' : '/admin/dashboard';
      ...
      >
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex gap-2">
            <Button onClick={() => router.push(dashboardLink)} variant="outline" className="gap-2">
            ...
            <DialogContent>
              ...
              <form onSubmit={(e) => {
                ...
                <div className="grid gap-2">
                  ...
                  <select name="role" defaultValue={editUser.role} className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50">
                ...
                <div className="grid gap-2">
                  <label className="text-sm font-medium">Class & Section (Students only)</label>
                  <select
                    name="class"
                ...
                <div className="grid gap-2">
                  ...
                  <Input name="roll" defaultValue={editUser.roll} />
                </div>
          ...
          <Dialog open={showAddUser} onOpenChange={setShowAddUser}>
            <DialogContent>
              ...
              <form onSubmit={(e) => {
                ...
                <div className="grid gap-2">
                  <label className="text-sm font-medium">Class (Students)</label>
